...
const NAV: NavItem[] = [
  ...
  { to: "/account/inquiries", label: "Inquiries", icon: MessageSquare },
  { to: "/account/documents", label: "Documents", icon: FolderOpen },
  ...
  return (
    <aside className="w-60 shrink-0 bg-onyx text-ivory flex flex-col min-h-screen sticky top-0">
      <div className="px-6 py-6 border-b border-ivory/10">
        ...
        <span className="text-[10px] uppercase tracking-[0.3em] text-ivory/40">Client Portal</span>
      </div>
